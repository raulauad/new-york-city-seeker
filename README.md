...
+<ol>
+  <li>La usuaria ingresa un término en la barra de búsqueda. Un <em>debounce</em> dispara búsquedas automáticas tras 450&nbsp;ms, o inmediatamente al hacer clic en «Buscar».</li>
...
+  <li>Internacionalizar la interfaz añadiendo archivos JSON de traducción y alternando textos en el DOM.</li>
